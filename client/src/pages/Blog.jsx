...
const Blog = () => {
  ...
  //read the dynamic values (parameters) directly out of the current website URL bar so you can use them inside your components.
  const {id} = useParams();
  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        {/*take reference from momentjs.com docs */}
